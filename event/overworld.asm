...
UsedSurfLavaScript: ; c986
	writetext UsedSurfLavaText ; "used SURF!"
	waitbutton
	closetext
...
UsedSurfLavaText: ; c9a9
	text_jump _UsedSurfLavaText
	db "@"
...
.cont
	...
	ld a, BANK(AskSurfLavaScript)
	ld hl, AskSurfLavaScript
	call CallScript
...
.cantsurflavayet
	ld a, BANK(CantSurfLavaOWScript)
	ld hl, CantSurfLavaOWScript
	call CallScript
	scf
	ret
...
.cantsurfyet
	ld a, BANK(CantSurfOWScript)
	ld hl, CantSurfOWScript
	call CallScript
	scf
	ret
...
CantSurfYetText:
	text_jump _CantSurfYetText ; The water is calm.
	db "@"              ; Want to SURF?
	
CantSurfLavaOWScript:
	opentext
	writetext CantSurfLavaYetText
	waitbutton
	closetext
	end
	
CantSurfLavaYetText:
	text_jump _CantSurfLavaYetText ; The water is calm.
	db "@"              ; Want to SURF?
	
AskSurfLavaScript: ; ca2c
	opentext
	writetext AskSurfLavaText
	yesorno
	iftrue UsedSurfLavaScript
	closetext
	end

AskSurfLavaText: ; ca36
	text_jump _AskSurfLavaText ; The water is calm.
	db "@"              ; Want to SURF?
