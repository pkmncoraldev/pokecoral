...
TrainerEncounterMusic: ; e9027
	...
	db MUSIC_HIKER_ENCOUNTER		 ;teacherfast
	db MUSIC_HIKER_ENCOUNTER		 ;triobror
	db MUSIC_HIKER_ENCOUNTER		 ;triobrob
	db MUSIC_HIKER_ENCOUNTER		 ;triobroy
	db MUSIC_HIKER_ENCOUNTER		 ;disguiseman
	db MUSIC_BEAUTY_ENCOUNTER		 ;lady
	db MUSIC_BEAUTY_ENCOUNTER		 ;bikinip
	db MUSIC_BEAUTY_ENCOUNTER		 ;bikinir
	db MUSIC_BEAUTY_ENCOUNTER		 ;bikiniy
