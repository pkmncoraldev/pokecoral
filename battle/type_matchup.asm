...
; All other cases are neutral (1x).
	...
	db FP_T,      NORMAL,    SUPER_EFFECTIVE
	db FP_T,      GRASS,     SUPER_EFFECTIVE
	db FP_T,      ICE,       SUPER_EFFECTIVE
	db FP_T,      FIGHTING,  SUPER_EFFECTIVE
	db FP_T,      DARK,      SUPER_EFFECTIVE
	db FP_T,      ELECTRIC,  NOT_VERY_EFFECTIVE
	db FP_T,      POISON,    NOT_VERY_EFFECTIVE
	db FP_T,      FLYING,    NOT_VERY_EFFECTIVE
	db FP_T,      PSYCHIC,   NOT_VERY_EFFECTIVE
	db FP_T,      FAIRY_T,   NOT_VERY_EFFECTIVE
	db FP_T,      GHOST,     NO_EFFECT
