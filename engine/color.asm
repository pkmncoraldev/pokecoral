...
GetBattlemonBackpicPalettePointer:
	...
	ret
.buizel
	call GetPlayerOrMonPalettePointerBuizel
	pop de
	ret
.floatzel
	call GetPlayerOrMonPalettePointerFloatzel
	pop de
	ret
...
;GetBuizelBackSpritePalettePointer:
;	ld hl, BuizelBackPalette
	
GetPlayerOrMonPalettePointerBuizel:
	and a
	add $1
	jp nz, GetMonNormalOrShinyPalettePointerBuizel
	
GetPlayerOrMonPalettePointerFloatzel:
	and a
	jp nz, GetMonNormalOrShinyPalettePointerBuizel
...
GetFrontpicPalettePointerFloatzel:
	and a
	sub $1
	jp nz, GetMonNormalOrShinyPalettePointer
	ld a, [TrainerClass]
	cp $0
	jp z, GetFrontpicPlayerPalettePointer
...
GetFrontpicPlayerPalettePointer:
	ld a, [wPlayerPalette]
	sub $1
	jp nz, .cont1
	ld hl, PlayerPalette
...
GetMonNormalOrShinyPalettePointerBuizel:
	push bc
	call GetMonPalettePointer2
	pop bc
	push hl
	call CheckShininess
	pop hl
