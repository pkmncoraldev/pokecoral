...
.Chris:
	...
	db PLAYER_DODRIO,	 SPRITE_DODRIO_RIDE
	db PLAYER_INVISIBLE, SPRITE_INVISIBLE
	db $ff
...
Group6Sprites: ; 14531
	...
	db SPRITE_BIG_SNORLAX
	db SPRITE_LASS
	db SPRITE_RODNEY_FISHER
	db SPRITE_YOUNGSTER
	db SPRITE_GENTLEMAN_GRUNTF
	db SPRITE_POKEFAN_M
	db SPRITE_POKEFAN_F
	db SPRITE_LEILANI_PSYDUCK
	db SPRITE_CORSOLA
	db SPRITE_GRANNY
	db SPRITE_POKE_BALL
	db SPRITE_SLOWPOKE
