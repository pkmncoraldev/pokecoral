...
ENDM
	...
	engine_flag OnwaBadges, 0 ; zephyrbadge
	engine_flag OnwaBadges, 1 ; hivebadge
	engine_flag OnwaBadges, 2 ; plainbadge
	engine_flag OnwaBadges, 3 ; fogbadge
	engine_flag OnwaBadges, 4 ; mineralbadge
	engine_flag OnwaBadges, 5 ; stormbadge ; $20
	engine_flag OnwaBadges, 6 ; glacierbadge
	engine_flag OnwaBadges, 7 ; risingbadge
	...
	engine_flag StatusFlags3, 0 ; punks in starglow
	...
	engine_flag MetGymLeaderFlags, 2
	engine_flag MetGymLeaderFlags, 3
