...
; Johto
	...
	flypoint DAYBREAK,      VIOLET_CITY
	flypoint GLINT,      AZALEA_TOWN
	flypoint STARGLOW,        LAKE_OF_RAGE
	flypoint SUNBEAM, CHERRYGROVE_CITY
...
endm
	...
	townmappals 1, 1, 1, 2, 2, 2, 0, 0, 2, 2, 0, 0, 0, 0, 0, 0
