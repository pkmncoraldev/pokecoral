...
ENDM
	...
	npctrade 1, CORPHISH,     VOLTORB,    "VOLTY@@@@@@", $98, $88, PRZCUREBERRY, 29189, "TIM@@@@@@@@", TRADE_EITHER_GENDER
	...
	npctrade 3, NUMEL,    AERODACTYL, "AEROY@@@@@@", $96, $66, GOLD_BERRY,   26491, "KIM@@@@@@@@", TRADE_EITHER_GENDER
	npctrade 0, DUGTRIO,    MAGNETON,   "MAGGIE@@@@@", $96, $66, METAL_COAT,   50082, "FOREST@@@@@", TRADE_EITHER_GENDER
	npctrade 0, 0,          TOGEPI,     "EGGY@@@@@@@", $2a, $aa, BERRY,        32986, "CINDY@@@@@@", TRADE_MALE_ONLY
