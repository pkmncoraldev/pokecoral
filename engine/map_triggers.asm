...
ENDM
	...
	trigger_def SUNSET_CAPTAINS_HOUSE,                  wSunsetCaptainsHouseTrigger
	...
	trigger_def SUNSET_BAY,                   	        wSunsetBayTrigger
	...
	trigger_def SUNSET_LIGHTHOUSE,                  	wSunsetLighthouseTrigger
	trigger_def RUINS_OF_ALPH_RESEARCH_CENTER,          wRuinsOfAlphResearchCenterTrigger
	trigger_def SUNSET_CAPE_ROUTE_1_GATE,               wRuinsOfAlphHoOhChamberTrigger
	trigger_def RUINS_OF_ALPH_KABUTO_CHAMBER,           wRuinsOfAlphKabutoChamberTrigger
	trigger_def RUINS_OF_ALPH_OMANYTE_WORD_ROOM,        wRuinsOfAlphOmanyteWordRoomTrigger
	...
	trigger_def RUINS_OF_ALPH_AERODACTYL_WORD_ROOM,     wRuinsofAlphAerodactylWordRoomTrigger
	trigger_def AZALEA_GYM,                             wAzaleaGymTrigger
	trigger_def RUINS_OF_ALPH_AERODACTYL_ITEM_ROOM,     wRuinsofAlphAerodactylItemRoomTrigger
	trigger_def LAKE_OF_RAGE_HIDDEN_POWER_HOUSE,     	wLakeOfRageHiddenPowerHouseTrigger
	trigger_def ROUTE_45,     							wRoute45Trigger
	trigger_def ROUTE_30,                               wRoute30Trigger
	trigger_def LAKE_OF_RAGE,							wLakeOfRageTrigger
	trigger_def OLIVINE_LIGHTHOUSE_1F,					wOlivineLighthouse1FTrigger
	trigger_def ROUTE_33,								wRoute33Trigger
	trigger_def UNION_CAVE_1F,							wUnionCave1FTrigger
	trigger_def OLIVINE_LIGHTHOUSE_5F,					wOlivineLighthouse5FTrigger
	trigger_def NATIONAL_PARK_BUG_CONTEST,				wNationalParkBugContestTrigger
