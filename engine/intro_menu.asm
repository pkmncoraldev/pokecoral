...
; Play the title screen music.
	...
	callba TitleScreenPaletteAnimation
...
;	call Request2bpp
;	hlcoord 0, 1
;	ld de, PreSplashScreenString
;	jp PlaceString

;PreSplashScreenString:
;	db	" "
...
SplashScreenString:
	db	"   #MON  CORAL       VERSION is a    fanmade modification of #MON CRYSTAL   VERSION.  It was   created solely for    the purpose of   entertainment and is not to be sold for        profit.      "
	db	"                    "
	db	"                    "
	db	"                    "
	db	"                    "
	db	" Please support the  official  release!  "
...
CoralDevScreenSetup_PlaceTilemapString:
.loop
	ld a, [de]
	cp $ff
	ret z
