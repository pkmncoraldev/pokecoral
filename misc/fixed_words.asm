...
.a:			db EKANS, ARBOK, SEAKING, GALVANTULA, CROCONAW, UNOWN
			db -1
.i:			db EEVEE, GEODUDE, JOLTIK, PILOSWINE, ONIX
			db -1
.u:			db ARCANINE, SUDOWOODO, WEEPINBELL, VICTREEBEL, WOOPER, SWINUB
			db -1
.e:			db SKARMORY, AIPOM, ESPEON, LOPUNNY, ELEKID, ELECTABUZZ, ENTEI
			db -1
.o:			db FERALIGATR, FURRET, OCTILLERY, PRIMEAPE, SENTRET, STANTLER, SPEAROW, FEAROW, WHIMSICOTT, COTTONEE
			db -1
.ka_ga		db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, ALTARIA, WARTORTLE, BLASTOISE, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN
			db -1
.ki_gi		db SUNFLORA, PIKIPEK, GYARADOS, RAPIDASH, FLOATZEL, GIRAFARIG, BELLOSSOM, KINGDRA, CRAWDAUNT
			db -1
.ku_gu		db GLOOM, PINECO, GLIGAR, CORPHISH, GRANBULL, CROBAT
			db -1
...
.ko_go		db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, PSYDUCK, PHANPY, RATTATA, GOLDUCK, GOLBAT, GOLEM, GRAVELER, VENONAT
			db -1
.sa_za		db RHYHORN, PUPITAR, CORSOLA, BUNEARY, ZAPDOS, JOLTEON, SANDSHREW, SANDSLASH ; RHYDON should lead this list
			db -1
.shi_ji	db SEADRA, SHELLDER, VAPOREON, BRELOOM
			db -1
.su_zu		db SUICUNE, STARMIE, SCYTHER, ZUBAT, BEEDRILL, MEDICHAM, MEDITITE
			db -1
.se_ze		db SQUIRTLE, MAROWAK_A
			db -1
.so_zo		db WOBBUFFET
			db -1
...
.tsu_du	db SHUCKLE
			db -1
.te_de		db DIGLETT, REMORAID, TOGEKISS, HOUNDOUR, AMPHAROS
			db -1
.to_do		db DODUO, DODRIO, SMEARGLE, KOFFING, TENTACRUEL, TOGETIC, TOGEPI, GOLDEEN, TRUMBEAK, DONPHAN
			db -1
...
.no		db DUNSPARCE
			db -1
.ha_ba_pa	db SHROOMISH, STEELIX, TYPHLOSION, DRAGONAIR, TOUCANNON, SCIZOR, ARON, CAMERUPT, DWEBBLE, CRUSTLE, QWILFISH, HAWLUCHA, SWABLU, CLOYSTER, TYRANITAR
			db -1
...
.he_be_pe	db BAYLEEF, GRIMER, MUK, HERACROSS, HOUNDOOM, PERSIAN, LICKITUNG
			db -1
.ho_bo_po	db RAICHU_A, NOIBAT, PIDGEY, PONYTA, LAIRON, PORYGON, PORYGON2
			db -1
...
.yu		db KADABRA
			db -1
.yo		db LARVITAR, NOIVERN
			db -1
.ra		db RAIKOU, RAICHU, NUMEL, RATICATE, LAPRAS, VILEPLUME, LANTURN
			db -1
.ri		db CHARMELEON, CHARIZARD, URSARING
			db -1
.ru		db VOLCARONA, LUGIA
			db -1
.re		db MAGNETON, LEDIAN, LEDYBA
			db -1
.ro		db BUIZEL
			db -1
.wa		db AGGRON, TOTODILE, MACHOP
.end		db -1
; 11d67e
