...
.ka_ga		db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, SNORLAX, KABUTO, KABUTOPS, HITMONTOP, WARTORTLE, BLASTOISE, FARFETCH_D, CUBONE, MAROWAK, KANGASKHAN
			db -1
.ki_gi		db SUNFLORA, PIKIPEK, GYARADOS, RAPIDASH, FLOATZEL, GIRAFARIG, BELLOSSOM, KINGDRA, KINGLER
			db -1
...
.no		db DUNSPARCE
			db -1
.ha_ba_pa	db SHROOMISH, STEELIX, TYPHLOSION, DRAGONAIR, TOUCANNON, SCIZOR, HOPPIP, BLISSEY, DWEBBLE, CRUSTLE, QWILFISH, HAWLUCHA, TYROGUE, CLOYSTER, TYRANITAR
			db -1
