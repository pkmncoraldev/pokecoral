...
RuinsofAlphKabutoChamber_BlockData:
	INCBIN "maps/RuinsofAlphPuzzleChamber2.blk"
...
SpookyForest1_BlockData:
	INCBIN "maps/SpookyForest1.blk"
	
SpookyForest2_BlockData:
	INCBIN "maps/SpookyForest2.blk"
	
SpookyForest3_BlockData:
	INCBIN "maps/SpookyForest3.blk"
	
SpookyForest4_BlockData:
	INCBIN "maps/SpookyForest4.blk"
	
SpookyForest5_BlockData:
	INCBIN "maps/SpookyForest5.blk"
	
SpookyForest6_BlockData:
	INCBIN "maps/SpookyForest6.blk"
	
SpookyForest7_BlockData:
	INCBIN "maps/SpookyForest7.blk"
	
SpookyForest8_BlockData:
	INCBIN "maps/SpookyForest8.blk"
	
SpookyForest9_BlockData:
	INCBIN "maps/SpookyForest9.blk"
