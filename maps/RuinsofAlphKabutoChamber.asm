...
.ObjectEvents: db 5
	...
	person_event SPRITE_TWIN, 6, 1, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, SpookHouseNPC1, EVENT_SPOOKHOUSE_TV_ROOM_GIRLS_GONE
	person_event SPRITE_TWIN, 6, 3, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, SpookHouseNPC1, EVENT_SPOOKHOUSE_TV_ROOM_GIRLS_GONE
	person_event SPRITE_TWIN, 7, 2, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, SpookHouseNPC1, EVENT_SPOOKHOUSE_TV_ROOM_GIRLS_GONE
	person_event SPRITE_TWIN, 5, 2, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_PINK, PERSONTYPE_SCRIPT, 0, SpookHouseNPC1, EVENT_SPOOKHOUSE_TV_ROOM_GIRLS_GONE
...
SpookHouseTVRoom1:
	...
	setevent EVENT_SPOOKHOUSE_FRONT_DOOR_LOCKED
