...
MapGroup1:
	map_header SunsetPokeCenter1F, TILESET_POKECENTER, INDOOR, SUNSET_BAY, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineGym, TILESET_OLIVINE_GYM, INDOOR, SUNSET_BAY, MUSIC_GYM, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header SunsetGrassWaterHouse, TILESET_HOUSE_1, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SunsetCaptainsHouse, TILESET_KURT_HOUSE, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SunsetOldCoupleHouse, TILESET_HOUSE_1, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SunsetLegendsHouse, TILESET_HOUSE_1, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SunsetCafe, TILESET_GAME_CORNER, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineMart, TILESET_MART, INDOOR, SUNSET_BAY, MUSIC_VIOLET_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route38EcruteakGate, TILESET_GATE, GATE, OCEAN, MUSIC_ROUTE_37, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route39Farmhouse, TILESET_SUNSET_BAY, ROUTE, OCEAN, MUSIC_ROUTE_37, 0, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup2:
	...
	map_header MahoganyTown, TILESET_GLINT, TOWN, MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup3:
	...
	map_header RuinsofAlphOutside, TILESET_GLINT, ROUTE, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header SunsetCapeRoute1Gate, TILESET_GATE, GATE, SUNSET_CAPE, MUSIC_ROUTE_1_NEW, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphInnerChamber, TILESET_SPOOKY_FOREST, DUNGEON, RUINS_OF_ALPH, MUSIC_RUINS_OF_ALPH_INTERIOR, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphResearchCenter, TILESET_POWER_PLANT, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphHoOhItemRoom, TILESET_SPOOKY_FOREST, DUNGEON, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphKabutoItemRoom, TILESET_SPOOKY_FOREST, DUNGEON, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphHoOhWordRoom, TILESET_ISLAND, DUNGEON, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphKabutoWordRoom, TILESET_KABUTO_WORD_ROOM, DUNGEON, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DAY, FISHGROUP_SHORE
	...
	map_header IlexForest, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header WarehouseEntrance, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest1, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest2, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest3, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest4, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest5, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest6, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest7, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest8, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header SpookyForest9, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header UndergroundPathSwitchRoomEntrances, TILESET_SPOOKY_FOREST, ROUTE, ILEX_FOREST, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	...
	map_header UndergroundWarehouse, TILESET_UNDERGROUND, DUNGEON, GOLDENROD_CITY, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header MountMortar1FOutside, TILESET_WHIRL_ISLANDS, CAVE, MT_MORTAR, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header MountMortar1FInside, TILESET_WHIRL_ISLANDS, CAVE, MT_MORTAR, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header MountMortar2FInside, TILESET_WHIRL_ISLANDS, CAVE, MT_MORTAR, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header MountMortarB1F, TILESET_WHIRL_ISLANDS, CAVE, MT_MORTAR, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	...
	map_header WhirlIslandNW, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandNE, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandSW, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandCave, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandSE, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandB1F, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandB2F, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	map_header WhirlIslandLugiaChamber, TILESET_WHIRL_ISLANDS, CAVE, WHIRL_ISLANDS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_DARK, FISHGROUP_WHIRL_ISLANDS
	...
	map_header DragonsDenB1F, TILESET_GLINT, CAVE, DRAGONS_DEN, MUSIC_DRAGONS_DEN, 1, PALETTE_NITE, FISHGROUP_DRATINI
	map_header DragonShrine, TILESET_LAB, INDOOR, DRAGONS_DEN, MUSIC_DRAGONS_DEN, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header TohjoFalls, TILESET_CAVE, CAVE, TOHJO_FALLS, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	...
	map_header SunsetLighthouse, TILESET_UNDERGROUND, GATE, LIGHTHOUSE, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup4:
	...
	map_header EcruteakCity, TILESET_GLINT, TOWN, ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header SunsetBay, TILESET_SUNSET_BAY, TOWN, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header SunsetCape, TILESET_SUNSET_BAY, ROUTE, SUNSET_CAPE, MUSIC_SUNSET_BAY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header Ocean1, TILESET_SUNSET_BAY, ROUTE, OCEAN, MUSIC_ROUTE_2_NEW, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header Ocean2, TILESET_SUNSET_BAY, ROUTE, OCEAN, MUSIC_ROUTE_2_NEW, 0, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup5:
	...
	map_header BlackthornCity, TILESET_GLINT, TOWN, BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, 0, PALETTE_AUTO, FISHGROUP_POND
...
MapGroup6:
	...
	map_header CinnabarPokeCenter2FBeta, TILESET_POKECENTER, INDOOR, ROUTE_30, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route19FuchsiaGate, TILESET_CAVE, CAVE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header Route19, TILESET_MOUNTAIN, ROUTE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route20, TILESET_CAVE, CAVE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header DanceTheatre, TILESET_MOUNTAIN, ROUTE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route21, TILESET_CAVE, CAVE, DAYBREAK_GROTTO, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header Route46, TILESET_LAVA_CAVE, CAVE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header Route44, TILESET_LAVA_CAVE, CAVE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header Route31, TILESET_LAVA_CAVE, CAVE, SPROUT_TOWER, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header CinnabarIsland, TILESET_KANTO, TOWN, CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header Route30, TILESET_ISLAND, ROUTE, ROUTE_30, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route35Goldenrodgate, TILESET_LAB, INDOOR, ROUTE_30, MUSIC_ROUTE_4_NEW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route36RuinsofAlphgate, TILESET_LAB, INDOOR, ROUTE_30, MUSIC_ROUTE_4_NEW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route35NationalParkgate, TILESET_KRISS_HOUSE, INDOOR, ROUTE_30, MUSIC_ROUTE_4_NEW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route36NationalParkgate, TILESET_KRISS_HOUSE, INDOOR, ROUTE_30, MUSIC_ROUTE_4_NEW, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup7:
	...
	map_header LakeofRage, TILESET_GLINT, TOWN, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header OlivineLighthouse1F, TILESET_HOUSE_1, INDOOR, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineLighthouse2F, TILESET_HOUSE_1, INDOOR, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineLighthouse3F, TILESET_HOUSE_1, INDOOR, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineLighthouse4F, TILESET_HOUSE_1, INDOOR, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineLighthouse5F, TILESET_POKECENTER, INDOOR, LAKE_OF_RAGE, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header OlivineLighthouse6F, TILESET_MART, INDOOR, LAKE_OF_RAGE, MUSIC_STARGLOW, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header SeafoamGym, TILESET_KURT_HOUSE, INDOOR, LAKE_OF_RAGE, MUSIC_GYM, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route33, TILESET_GLINT, ROUTE, ROUTE_43, MUSIC_ROUTE_2_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route34, TILESET_GLINT, ROUTE, ROUTE_34, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route42, TILESET_GLINT, ROUTE, ROUTE_42, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route40, TILESET_GLINT, ROUTE, ROUTE_42, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE


MapGroup8:
	map_header AzaleaPokeCenter1F, TILESET_POKECENTER, INDOOR, AZALEA_TOWN, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header CharcoalKiln, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AzaleaMart, TILESET_MART, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KurtsHouse, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header BillsHouse, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header LakeofRageHiddenPowerHouse, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header AzaleaGym, TILESET_POWER_PLANT, INDOOR, AZALEA_TOWN, MUSIC_GYM, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route45, TILESET_ISLAND, ROUTE, ROUTE_45, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route41, TILESET_ISLAND, ROUTE, ROUTE_41, MUSIC_ROUTE_4_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header CherrygroveCity, TILESET_ISLAND, TOWN, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header NationalPark, TILESET_ISLAND, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header NationalParkBugContest, TILESET_ISLAND, TOWN, CHERRYGROVE_CITY, MUSIC_GAME_CORNER, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route29, TILESET_ISLAND, TOWN, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header Route27, TILESET_ISLAND, INDOOR, CHERRYGROVE_CITY, MUSIC_GYM, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map_header CherrygroveGymSpeechHouse, TILESET_JUNGLE, INDOOR, CHERRYGROVE_CITY, MUSIC_GYM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header ElmsHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissNeighborsHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header GuideGentsHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header CherrygroveEvolutionSpeechHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route30BerrySpeechHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header MrPokemonsHouse, TILESET_KRISS_HOUSE, INDOOR, CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header VioletGym, TILESET_GYM_1, INDOOR, VIOLET_CITY, MUSIC_GYM, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route43MahoganyGate, TILESET_GATE, GATE, ROUTE_43, MUSIC_ROUTE_4_NEW, 0, PALETTE_DAY, FISHGROUP_SHORE


MapGroup9:
	map_header LakeofRageMagikarpHouse, TILESET_HOUSE_1, INDOOR, LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route43Gate, TILESET_CAVE, CAVE, DAYBREAK_GROTTO, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header Route43, TILESET_GLINT, ROUTE, ROUTE_43, MUSIC_ROUTE_2_NEW, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header AzaleaTown, TILESET_GLINT, TOWN, AZALEA_TOWN, MUSIC_GLINT_CITY, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route35, TILESET_GLINT, ROUTE, AZALEA_TOWN, MUSIC_ECRUTEAK_CITY, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header UnionCave1F, TILESET_STARGLOW_CAVERN, CAVE, UNION_CAVE, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header UnionCaveB1F, TILESET_STARGLOW_CAVERN, CAVE, UNION_CAVE, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_LAKE
	map_header UnionCaveB2F, TILESET_STARGLOW_CAVERN, CAVE, UNION_CAVE, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE


MapGroup10:
	map_header Route36, TILESET_GLINT, ROUTE, ROUTE_36, MUSIC_ROUTE_2_NEW, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route37, TILESET_GLINT, ROUTE, ROUTE_37, MUSIC_ROUTE_1_NEW, 0, PALETTE_AUTO, FISHGROUP_SHORE
	map_header VioletCity, TILESET_GLINT, TOWN, VIOLET_CITY, MUSIC_DAYBREAK_VILLAGE, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header VioletMart, TILESET_CAVE, CAVE, DAYBREAK_GROTTO, MUSIC_DAYBREAK_GROTTO, 0, PALETTE_NITE, FISHGROUP_POND
	map_header EarlsPokemonAcademy, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_DAYBREAK_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header VioletNicknameSpeechHouse, TILESET_KURT_HOUSE, INDOOR, VIOLET_CITY, MUSIC_DAYBREAK_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header VioletPokeCenter1F, TILESET_POKECENTER, INDOOR, VIOLET_CITY, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header VioletOnixTradeHouse, TILESET_KURT_HOUSE, INDOOR, VIOLET_CITY, MUSIC_DAYBREAK_VILLAGE, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header Route32PokeCenter1F, TILESET_POKECENTER, INDOOR, ROUTE_32, MUSIC_POKEMON_CENTER, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header RuinsofAlphOmanyteWordRoom, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphOmanyteChamber, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphOmanyteItemRoom, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphAerodactylWordRoom, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphAerodactylItemRoom, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphAerodactylChamber, TILESET_OMANYTE_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
	map_header RuinsofAlphKabutoChamber, TILESET_KABUTO_WORD_ROOM, INDOOR, RUINS_OF_ALPH, MUSIC_DAYBREAK_GROTTO, 1, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup15:
	map_header OlivinePort, TILESET_PORT, ROUTE, SUNSET_BAY, MUSIC_VIOLET_CITY, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map_header OlivinePortPassage, TILESET_UNDERGROUND, INDOOR, SUNSET_BAY, MUSIC_VIOLET_CITY, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup22:
	map_header CianwoodCity, TILESET_GLINT, TOWN, CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, 0, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map_header BattleTower1F, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 1, PALETTE_DAY, FISHGROUP_SHORE
	map_header BattleTowerBattleRoom, TILESET_HOUSE_1, INDOOR, AZALEA_TOWN, MUSIC_GLINT_CITY, 1, PALETTE_DAY, FISHGROUP_SHORE
	...
	map_header BattleTowerOutside, TILESET_GROVE, ROUTE, BATTLE_TOWER, MUSIC_BATTLE_TOWER_THEME, 0, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup24:
	map_header Route26, TILESET_GLINT, ROUTE, ROUTE_26, MUSIC_ROUTE_26, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header NewBarkTown, TILESET_GLINT, TOWN, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, 0, PALETTE_AUTO, FISHGROUP_OCEAN
	map_header ElmsLab, TILESET_LAB, INDOOR, CHERRYGROVE_CITY, MUSIC_PROF_ELM, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissHouse1F, TILESET_KRISS_HOUSE, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
	map_header KrissHouse2F, TILESET_KRISS_HOUSE_2F, INDOOR, SUNSET_BAY, MUSIC_SUNSET_BAY, 0, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup27:
	map_header Route32, TILESET_GROVE, ROUTE, GLINT_GROVE, MUSIC_ECRUTEAK_CITY, 0, PALETTE_AUTO, FISHGROUP_POND
	map_header Route32RuinsofAlphGate, TILESET_GROVE, ROUTE, GLINT_GROVE, MUSIC_ECRUTEAK_CITY, 0, PALETTE_AUTO, FISHGROUP_QWILFISH
