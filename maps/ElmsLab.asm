...
.Warps: db 3
	warp_def 7, 4, -1, CHERRYGROVE_CITY
...
.ObjectEvents: db 5
	...
	person_event SPRITE_LUGIA, 5, 9, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, SpruceLabMunchlax, EVENT_SPRUCELAB_MUNCH1_GONE
	person_event SPRITE_OAK, 0, 5, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, (1 << 3) | PAL_OW_BROWN, PERSONTYPE_SCRIPT, 0, SpruceLabSpruce, EVENT_SPRUCELAB_SPRUCE2_GONE
...
;SetDestination:
;	checkevent EVENT_CHANGED_THE_WARP
;	iftrue .changed
;	warpmod 1, CHERRYGROVE_CITY
;	warpmod 1, CHERRYGROVE_CITY
;	return

;.changed:
;	warpmod 1, LAKE_OF_RAGE
;	warpmod 1, LAKE_OF_RAGE
;	return
...
.cont
	...
	warpfacing UP, NATIONAL_PARK, $10, $b
	end
.alreadytalked
	faceplayer
	opentext
...
SpruceLabMunchlax:
	setevent EVENT_CHANGED_THE_WARP
	checkevent EVENT_TALKED_TO_SPRUCE
	iftrue .alreadytalked
