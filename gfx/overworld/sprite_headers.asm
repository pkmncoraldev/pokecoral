...
StanleySprite: ; 1479c
	sprite_header StanleySpriteGFX, 3, WALKING_SPRITE, PAL_OW_BLUE
; 147a2

RodneySprite: ; 147a2
	sprite_header RodneySpriteGFX, 3, WALKING_SPRITE, PAL_OW_BLUE
; 147a8

LeilaniSprite: ; 147a2
	sprite_header LeilaniSpriteGFX, 3, WALKING_SPRITE, PAL_OW_BROWN
; 147ae
...
FruitTreeSprite: ; 1495e
	sprite_header FruitTreeSpriteGFX, 1, STILL_SPRITE, PAL_OW_SILVER
; 14964
...
; 1499a
BoatLeft:
	sprite_header BoatLeftGFX, 1, STILL_SPRITE, PAL_OW_BROWN

BoatRight:
	sprite_header BoatRightGFX, 1, STILL_SPRITE, PAL_OW_BROWN
	
ChrisRunSprite:
	sprite_header ChrisRunSpriteGFX, 3, WALKING_SPRITE, PAL_OW_RED
	
KrisRunSprite:
	sprite_header KrisRunSpriteGFX, 3, WALKING_SPRITE, PAL_OW_RED
