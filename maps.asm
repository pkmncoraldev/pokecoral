...
INCLUDE "maps/SunsetCapeRoute1Gate.asm"
...
INCLUDE "maps/SunsetPokeCenter1F.asm"
INCLUDE "maps/OlivineGym.asm"
INCLUDE "maps/SunsetGrassWaterHouse.asm"
INCLUDE "maps/SunsetCaptainsHouse.asm"
INCLUDE "maps/SunsetOldCoupleHouse.asm"
