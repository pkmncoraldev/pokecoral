...
; ???
	...
	const EVENT_CHARMANDER_POKEBALL_IN_LIGHTHOUSE
	const EVENT_SQUIRTLE_POKEBALL_IN_LIGHTHOUSE
	const EVENT_BULBASAUR_POKEBALL_IN_LIGHTHOUSE
	const EVENT_GOT_CHARMANDER_FROM_ELM
	const EVENT_GOT_SQUIRTLE_FROM_ELM
	const EVENT_GOT_BULBASAUR_FROM_ELM
	...
	const EVENT_SUNSET_CAPE_MORN_NPC
	const EVENT_SUNSET_CAPE_DAY_NPC
	const EVENT_SUNSET_CAPE_NIGHT_NPC
	const EVENT_GOT_TM_FROM_STANLEY
	const EVENT_HAVE_SURF
	const EVENT_END_DEMO
	const EVENT_WATERWAY_POKE_BALL
	const EVENT_BEAT_OCEAN1_TRAINER1
	const EVENT_BEAT_OCEAN1_TRAINER2
	const EVENT_BEAT_OCEAN1_TRAINER3
	const EVENT_BEAT_OCEAN1_TRAINER4
	const EVENT_BEAT_OCEAN2_TRAINER1
	const EVENT_BEAT_OCEAN2_TRAINER2
	const EVENT_BEAT_SUNSET_CAPE_TRAINER
	const EVENT_GLINT_GROVE_POKE_BALL
	const EVENT_SPOOKHOUSE_SAW_GHOST_1
	const EVENT_SPOOKHOUSE_BALL_WILL_MOVE_LEFT
	...
	const EVENT_CAN_ENTER_ISLAND
	const EVENT_LAKE_BOAT_RIGHT_GONE
	const EVENT_LAKE_BOAT_LEFT_GONE
	const EVENT_TAKEN_LAKE_BOAT_ONCE
	const EVENT_JUST_TOOK_BOAT
	const EVENT_BOAT_BOYS_BEGONE
	...
	const EVENT_STAR_GLOW_CAVERN_POKE_BALL1
	const EVENT_STAR_GLOW_CAVERN_POKE_BALL2
	const EVENT_STAR_GLOW_CAVERN_POKE_BALL3
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINER_1
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINER_2
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINER_3
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINER_4
	...
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINERB1F_1
	const EVENT_BEAT_STARGLOW_CAVERN_TRAINERB1F_2
	const EVENT_BEAT_ROUTE4_TRAINER_1
	const EVENT_BEAT_ROUTE4_TRAINER_2
	const EVENT_BEAT_ROUTE4_TRAINER_3
	const EVENT_BEAT_ROUTE4_TRAINER_4
	const EVENT_BEAT_ROUTE5_TRAINER_1
	const EVENT_BEAT_ROUTE5_TRAINER_2
	const EVENT_BEAT_ROUTE5_TRAINER_3
	const EVENT_BEAT_ROUTE5_TRAINER_4
	const EVENT_BEAT_ROUTE5_TRAINER_5
	const EVENT_TALKED_TO_FISHING_GURU
	const EVENT_BEAT_ROUTE6_TRAINER_1
	const EVENT_BEAT_ROUTE6_TRAINER_2
	const EVENT_BEAT_ROUTE6_TRAINER_3
	const EVENT_BEAT_ROUTE6_TRAINER_4
	const EVENT_BEAT_ROUTE6_TRAINER_5
	const EVENT_BEAT_ROUTE6_TRAINER_6
	const EVENT_BEAT_ROUTE6_TRAINER_7
	const EVENT_ROUTE_6_POKE_BALL_THUNDERPUNCH
	const EVENT_ROUTE6_HIDDEN_ULTRA_BALL
	const EVENT_SUNBEAM_BIKINI_CONTEST
	const EVENT_BEAT_SUNBEAM_CONTEST_BIKINIP
	const EVENT_BEAT_SUNBEAM_CONTEST_BIKINIR
	const EVENT_BEAT_SUNBEAM_CONTEST_BIKINIY
	...
	const EVENT_SAW_FIRST_BIKINI_CONTEST
	const EVENT_FOREST_GHOST_GIRL_GONE
	const EVENT_FOREST_GHOST_GIRL_GONE2
	const EVENT_STAR_GLOW_CAVERN_POKE_BALL4
	const EVENT_LAVA_CAVE_LARVESTA_GONE
	const EVENT_LAVA_CAVE_BF3_HIDDEN_REVIVE
	const EVENT_LAVA_CAVE_BF1_POKE_BALL1
	const EVENT_LAVA_CAVE_BF1_POKE_BALL2
	const EVENT_LAVA_CAVE_BF1_POKE_BALL3
	const EVENT_LAVA_CAVE_BF3_POKE_BALL
	const EVENT_CHANGED_THE_WARP
	...
	const EVENT_BEAT_ROUTE6_2_COUPLE
	const EVENT_RIVAL_ROUTE_6
	...
	const EVENT_GOT_RANCH_MASTERBALL
	const EVENT_ISLAND_SAVED_HEALED
	const EVENT_BEAT_ROUTE_2_SOUTH_TRAINER_1
	const EVENT_BEAT_ROUTE_2_SOUTH_TRAINER_2
	const EVENT_BEAT_ROUTE_2_SOUTH_TRAINER_3
	const EVENT_BEAT_ROUTE_2_SOUTH_TRAINER_4
...
; ???
	...
	const EVENT_ROUTE_2NEW_POKE_BALL
	const EVENT_ROUTE_2NEW_POKE_BALL2
	const EVENT_BEAT_TEACHER
	const EVENT_SCHOOL_KID_GAVE_BALLS
	const EVENT_ROUTE_3NEW_POKE_BALL
	const EVENT_ROUTE_3NEW_POKE_BALL_2
	...
	const EVENT_TALKED_TO_MOM_ABOUT_PASS
	const EVENT_BEAT_GLINT_GROVE_TRAINER_6
	const EVENT_BEAT_LEILANI
	const EVENT_GOT_TM_FROM_LEILANI
	const EVENT_ISLAND_GREEM_MAN
	const EVENT_GOT_MIRACLE_SEED
	const EVENT_LAKE_ONWA_POKE_BALL
	const EVENT_LAKE_ONWA_POKE_BALL2
	const EVENT_ISLAND_BLUE_CORSOLA
	const EVENT_SPOOKHOUSE_TV_ROOM_GIRLS_GONE
	const EVENT_RANCH_POKE_BALL_1
	const EVENT_RANCH_POKE_BALL_2
	const EVENT_FOREST_POKE_BALL_1
	const EVENT_FOREST_POKE_BALL_2
	const EVENT_SPOOKY_FOREST9_POKE_BALL
	const EVENT_ROUTE_9_POKE_BALL
	const EVENT_ROUTE_9_HIDDEN_RARE_CANDY
	const EVENT_BEAT_SUNBEAM_SNARE_1
	const EVENT_BEAT_SUNBEAM_SNARE_2
	const EVENT_BEAT_SUNBEAM_SNARE_3
	const EVENT_BEAT_SUNBEAM_SNARE_4
	const EVENT_BEAT_SUNBEAM_SNARE_5
	const EVENT_SPOOKHOUSE_FRONT_DOOR_LOCKED
	const EVENT_RANCH_RACE_POKE_BALL
	const EVENT_RANCH_RACE_CHECKPOINT1
	const EVENT_RANCH_RACE_CHECKPOINT2
	const EVENT_RANCH_RACE_CHECKPOINT3
	const EVENT_BEAT_ROUTE7_TRAINER_1
	...
	const EVENT_BEAT_MT_ONWA_TRAINER_1
	const EVENT_BEAT_MT_ONWA_TRAINER_2
	const EVENT_BEAT_MT_ONWA_TRAINER_3
	const EVENT_BEAT_MT_ONWA_TRAINER_4
	const EVENT_TRAIN_STATION_GUY_1
	const EVENT_TRAIN_STATION_GUY_2
	const EVENT_BEAT_MT_ONWA_OUTSIDE_TRAINER_1
	const EVENT_BEAT_MT_ONWA_OUTSIDE_TRAINER_2
	const EVENT_BEAT_MT_ONWA_OUTSIDE_TRAINER_3
	const EVENT_BEAT_MT_ONWA2_TRAINER_1
	const EVENT_BEAT_MT_ONWA2_TRAINER_2
	const EVENT_DAYBREAK_GROTTO_HIKER
	const EVENT_BEAT_LAVA_CAVE_BF1_TRAINER_1
	const EVENT_BEAT_LAVA_CAVE_BF1_TRAINER_2
	const EVENT_BEAT_LAVA_CAVE_BF1_TRAINER_3
	const EVENT_BEAT_LAVA_CAVE_BF3_TRAINER_1
	const EVENT_GOT_MYSTIC_WATER
	const EVENT_GOT_CHARCOAL
	const EVENT_MT_ONWA_CUTSCENE
	const EVENT_PLAYER_IS_MALE
	const EVENT_PLAYER_IS_FEMALE
	const EVENT_GOT_CLUE_1
	const EVENT_ISLAND_SAVED_LADY_CHAN
	const EVENT_ISLAND_LADY_CHAN_LEMONADE
	const EVENT_ISLAND_SAVED
	const EVENT_BEAT_HUNTERS_TRAINER_1
	const EVENT_BEAT_HUNTERS_TRAINER_2
	const EVENT_BEAT_HUNTERS_TRAINER_3
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_1
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_2
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_3
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_4
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_5
	const EVENT_BEAT_SUBEAM_GYM_TRAINER_6
	...
	const EVENT_BEAT_RANCH_TRAINER_1
	const EVENT_BEAT_RANCH_TRAINER_2
	const EVENT_BEAT_RANCH_TRAINER_3
	...
	const EVENT_DELINQUENTS_IN_TUNNEL
	const EVENT_3B1
	const EVENT_3B2
	const EVENT_3B3
	const EVENT_3B4
...
; GruntM
	const EVENT_BEAT_STARGLOW_ROCKET_1
	const EVENT_BEAT_STARGLOW_ROCKET_2
	const EVENT_BEAT_STARGLOW_ROCKET_3
...
; ???
	...
	const EVENT_639
	const EVENT_63A
	const EVENT_TALKED_TO_TRIO_BROS
