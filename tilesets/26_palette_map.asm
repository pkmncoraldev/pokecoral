...
endr
	...
	tilepal 1, BROWN, BROWN, BROWN, GRAY, GRAY, BROWN, WATER, WATER
	tilepal 1, GREEN, GREEN, GREEN, GREEN, BROWN, BROWN, GRAY, GRAY
	tilepal 1, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN, GRAY, GRAY
