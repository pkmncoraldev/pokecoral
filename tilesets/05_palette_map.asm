	...
	tilepal 0, GRAY, GRAY, RED, RED, WATER, BROWN, BROWN, BROWN
	...
	tilepal 0, GRAY, GRAY, WATER, GRAY, RED, RED, BROWN, WATER
	tilepal 0, RED, RED, RED, RED, GREEN, YELLOW, BROWN, BROWN
