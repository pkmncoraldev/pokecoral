...
BuizelIcon:       INCBIN "gfx/icon/buizel.2bpp"
FloatzelIcon:    INCBIN "gfx/icon/floatzel.2bpp"
...
DwebbleIcon:        INCBIN "gfx/icon/dwebble.2bpp"
CrustleIcon:     INCBIN "gfx/icon/crustle.2bpp"
...
ShroomishIcon:         INCBIN "gfx/icon/shroomish.2bpp"
BreloomIcon:      INCBIN "gfx/icon/breloom.2bpp"
...
MedititeIcon:      INCBIN "gfx/icon/meditite.2bpp"
MedichamIcon:        INCBIN "gfx/icon/medicham.2bpp"
CorphishIcon:       INCBIN "gfx/icon/corphish.2bpp"
CrawdauntIcon:      INCBIN "gfx/icon/crawdaunt.2bpp"
...
BunearyIcon:    INCBIN "gfx/icon/buneary.2bpp"
LopunnyIcon:   INCBIN "gfx/icon/lopunny.2bpp"
...
NumelIcon:      INCBIN "gfx/icon/numel.2bpp"
...
HawluchaIcon:       INCBIN "gfx/icon/hawlucha.2bpp"
ScytherIcon:      INCBIN "gfx/icon/scyther.2bpp"
VolcaronaIcon:         INCBIN "gfx/icon/volcarona.2bpp"
